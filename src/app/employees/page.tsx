import DataTable from '@/components/tables/employeeDataTable';
  ...
  return (
    <div className="min-h-screen p-8 bg-gray-50 text-gray-900 flex flex-col space-y-6 rounded-lg overflow-hidden mt-3">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Manage your employee details and roles
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <StatCard title="Average Salary" value={`$${Math.floor(
          employees.reduce((acc, e) => acc + e.salary, 0) / employees.length
        )}`} />
        <StatCard title="Managers" value={String(
